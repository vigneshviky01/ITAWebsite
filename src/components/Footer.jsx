  ...
  return (
    ...
    >
          ...
          stars.map((star) => (
            <motion.div
              ...
              className={`absolute rounded-full ${
                star.hasTwinkle ? "bg-white" : "bg-blue-50"
              }`}
              style={{
                left: star.left,
                top: star.top,
              ...
              animate={{
                opacity: star.hasTwinkle
                  ? star.brightness || [1, 1]
                  : [star.brightness?.[0] || 1, star.brightness?.[0] || 1],
      ...
      <div className="relative max-w-4xl mx-auto z-10">
        <div className="absolute max-sm:top-3 max-sm:left-1/2 top-0 left-1/2 max-sm:left-1 transform -translate-x-1/2 -translate-y-1/2 p-2 rounded-full">
          <img
            src="/1000019635-removebg-preview.png"
            alt="React Logo"
            className="max-sm:w-16 max-sm:h-16 w-25 h-25"
          />
        </div>
        <motion.h2
        ...
        <motion.p
          ...
          viewport={{ once: true }}
        >
          Stay connected and get exclusive tips, updates, and special offers. Be
      ...
      <div className="flex justify-center max-sm:pt-7 gap-6 mt-6 relative z-10">
        {[
          ...
          {
            icon: FaWhatsapp,
            link: "https://chat.whatsapp.com/FDdx7gUoMp3DLajQqDa4Nv",
          },
        ].map((platform, index) => (
          <motion.a
            key={index}
      ...
      {/* Bottom Section */}
      <div className="mt-6 border-t border-gray-700 pt-4 relative z-10 flex flex-col items-center justify-center">
